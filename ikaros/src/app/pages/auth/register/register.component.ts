...
@Component({
  ...
  template: `
    ...
    <div class="flex flex-col gap-2 border border-solid border-secondary p-8 rounded-xl">
        ...
        <h1 class="${hlmH2} border-b-0 pb-2 text-center">Create an account</h1>
        <p class="${hlmMuted} pb-2 w-80 text-center">Enter your details to get started.</p>
        <form
        ...
        <!-- Email -->
          ...
          <p class="${hlmMuted}">Already have an account? <a class="underline cursor-pointer" routerLink="/login">Log In</a></p>
          <br />
        </form>
